...
public class Filter2 extends Filter{
    ...
    public Filter2(Tess owner){
        super(owner);
    }

    @Override
    public boolean filter(Brick brick, Face f) {
        Index i1 = new Index(new int[]{0, 1, 1, 0});
        Index i2 = new Index(new int[]{0, 1, 0, 0});
        Index i3 = new Index(new int[]{0, 0, 1, 0});

        Index b1 = new Index(new int[]{1, 1, 0, 1});
        Index b2 = new Index(new int[]{1, 0, 1, 1});
        Index b3 = new Index(new int[]{1, 0, 0, 1});
    ...
    public boolean drakLine(Index index, Index indexTo) {
        Index[] bads = new Index[]{
                new Index(new int[]{1, 1, 0, 1}),
                new Index(new int[]{1, 0, 1, 1}),
                new Index(new int[]{1, 0, 0, 1}),
