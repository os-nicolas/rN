...
public class Filter4 extends Filter{
    ...
    public Filter4(Tess owner){
        super(owner);
    }

    @Override
    public boolean filter(Brick brick, Face f) {
        Index i1 = new Index(new int[]{0, 1, 0, 0});
        Index i2 = new Index(new int[]{0, 1, 0, 1});
        Index i3 = new Index(new int[]{1, 1, 0, 1});

        Index b1 = new Index(new int[]{0, 0, 1, 0});
        Index b2 = new Index(new int[]{1, 0, 0, 1});
        Index b3 = new Index(new int[]{0, 1, 1, 0});
        Index b4 = new Index(new int[]{1, 0, 1, 1});
